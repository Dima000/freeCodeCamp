...
```yml
tests:
  - text: Applica valoarea de rezerva (fallback value) <code>black</code> pentru proprietatea <code>background</code> din clasa <code>penguin-top</code>.
  ...
  - text: Applica valoarea de rezerva <code>black</code> pentru proprietatea <code>background</code> din clasa <code>penguin-bottom</code>.
